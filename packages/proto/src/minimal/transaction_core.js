...
const $root = $protobuf.roots.hashgraph_transaction_core || ($protobuf.roots.hashgraph_transaction_core = {});
...
export const proto = $root.proto = (() => {
    ...
    proto.Transaction = (function() {
         ...
         * @memberof proto
         * @classdesc A wrapper around signed transaction bytes.
        ...
        Transaction.fromObject = function fromObject(object) {
            ...
            if (object.signedTransactionBytes != null)
                ...
                else if (object.signedTransactionBytes.length >= 0)
    ...
    proto.SignedTransaction = (function() {
         ...
         * @memberof proto
         * @classdesc A combination transaction bytes and a map of signatures.
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        SignedTransaction.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.proto.SignedTransaction();
            while (reader.pos < end) {
                let tag = reader.uint32();
                if (tag === error)
                    break;
        ...
        SignedTransaction.fromObject = function fromObject(object) {
            if (object instanceof $root.proto.SignedTransaction)
                return object;
            let message = new $root.proto.SignedTransaction();
            if (object.bodyBytes != null)
                ...
                else if (object.bodyBytes.length >= 0)
    ...
    proto.TransactionBody = (function() {
         ...
         * @memberof proto
         * @classdesc A transaction body containing common fields.
         * Stripped-down version without the transaction-specific oneof.
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        TransactionBody.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
    ...
    proto.TransactionList = (function() {
         ...
         * @memberof proto
         * @classdesc An ordered list of transactions.
         ...
         * @memberof proto.TransactionList
         * @static
         * @param {proto.ITransactionList} message TransactionList message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        TransactionList.encode = function encode(message, writer) {
            ...
            if (message.transactionList != null && message.transactionList.length)
                for (let i = 0; i < message.transactionList.length; ++i)
                    $root.proto.Transaction.encode(message.transactionList[i], writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
            return writer;
        };

        /**
         * Encodes the specified TransactionList message, length delimited. Does not implicitly {@link proto.TransactionList.verify|verify} messages.
         * @function encodeDelimited
         * @memberof proto.TransactionList
         * @static
         * @param {proto.ITransactionList} message TransactionList message or plain object to encode
        ...
        TransactionList.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.proto.TransactionList();
            while (reader.pos < end) {
                let tag = reader.uint32();
                if (tag === error)
                    break;
                ...
                case 1: {
                        ...
                        message.transactionList.push($root.proto.Transaction.decode(reader, reader.uint32()));
                        break;
                    }
                default:
                    reader.skipType(tag & 7);
        ...
        TransactionList.verify = function verify(message) {
            ...
            if (message.transactionList != null && message.hasOwnProperty("transactionList")) {
                ...
                for (let i = 0; i < message.transactionList.length; ++i) {
                    let error = $root.proto.Transaction.verify(message.transactionList[i]);
                    if (error)
        ...
        TransactionList.fromObject = function fromObject(object) {
            if (object instanceof $root.proto.TransactionList)
                return object;
            let message = new $root.proto.TransactionList();
            if (object.transactionList) {
                if (!Array.isArray(object.transactionList))
                    throw TypeError(".proto.TransactionList.transactionList: array expected");
                message.transactionList = [];
                for (let i = 0; i < object.transactionList.length; ++i) {
                    if (typeof object.transactionList[i] !== "object")
                        throw TypeError(".proto.TransactionList.transactionList: object expected");
                    message.transactionList[i] = $root.proto.Transaction.fromObject(object.transactionList[i]);
                }
            }
            return message;
        };
         ...
         * @memberof proto.TransactionList
         * @static
         * @param {proto.TransactionList} message TransactionList
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        TransactionList.toObject = function toObject(message, options) {
            ...
            if (message.transactionList && message.transactionList.length) {
                object.transactionList = [];
                for (let j = 0; j < message.transactionList.length; ++j)
                    object.transactionList[j] = $root.proto.Transaction.toObject(message.transactionList[j], options);
            }
            return object;
        };
