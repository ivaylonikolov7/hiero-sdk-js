...
const $root = $protobuf.roots.hashgraph_consensus_info || ($protobuf.roots.hashgraph_consensus_info = {});
...
export const proto = $root.proto = (() => {
    ...
    proto.ConsensusGetTopicInfoResponse = (function() {
         ...
         */
        ConsensusGetTopicInfoResponse.decode = function decode(reader, length, error) {
    ...
    proto.FixedCustomFee = (function() {
         ...
         */
        function FixedCustomFee(properties) {
            if (properties)
                for (let keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
                        this[keys[i]] = properties[keys[i]];
         ...
         * @memberof proto.FixedCustomFee
         * @static
         * @param {proto.IFixedCustomFee} message FixedCustomFee message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        FixedCustomFee.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            ...
            if (message.feeCollectorAccountId != null && Object.hasOwnProperty.call(message, "feeCollectorAccountId"))
                $root.proto.AccountID.encode(message.feeCollectorAccountId, writer.uint32(/* id 2, wireType 2 =*/18).fork()).ldelim();
            return writer;
        };
         ...
         * @returns {$protobuf.Writer} Writer
         */
        FixedCustomFee.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        FixedCustomFee.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.proto.FixedCustomFee();
            while (reader.pos < end) {
                let tag = reader.uint32();
                if (tag === error)
                    break;
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        FixedCustomFee.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        FixedCustomFee.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
         ...
         * @returns {proto.FixedCustomFee} FixedCustomFee
         */
        FixedCustomFee.fromObject = function fromObject(object) {
            if (object instanceof $root.proto.FixedCustomFee)
                return object;
            let message = new $root.proto.FixedCustomFee();
            if (object.fixedFee != null) {
                if (typeof object.fixedFee !== "object")
                    throw TypeError(".proto.FixedCustomFee.fixedFee: object expected");
            ...
            if (object.feeCollectorAccountId != null) {
                if (typeof object.feeCollectorAccountId !== "object")
                    throw TypeError(".proto.FixedCustomFee.feeCollectorAccountId: object expected");
         ...
         * @memberof proto.FixedCustomFee
         * @static
         * @param {proto.FixedCustomFee} message FixedCustomFee
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        FixedCustomFee.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            let object = {};
            if (options.defaults) {
         ...
         * @returns {Object.<string,*>} JSON object
         */
        FixedCustomFee.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
    ...
    proto.ConsensusTopicInfo = (function() {
         ...
         * </ol>
         * @property {number|Long|null} [sequenceNumber] A current sequence number (starting at 1 for the first message)
        ...
        ConsensusTopicInfo.encode = function encode(message, writer) {
            ...
            if (message.ledgerId != null && Object.hasOwnProperty.call(message, "ledgerId"))
                writer.uint32(/* id 9, wireType 2 =*/74).bytes(message.ledgerId);
            if (message.feeScheduleKey != null && Object.hasOwnProperty.call(message, "feeScheduleKey"))
                $root.proto.Key.encode(message.feeScheduleKey, writer.uint32(/* id 10, wireType 2 =*/82).fork()).ldelim();
            if (message.feeExemptKeyList != null && message.feeExemptKeyList.length)
                for (let i = 0; i < message.feeExemptKeyList.length; ++i)
                    $root.proto.Key.encode(message.feeExemptKeyList[i], writer.uint32(/* id 11, wireType 2 =*/90).fork()).ldelim();
            if (message.customFees != null && message.customFees.length)
                for (let i = 0; i < message.customFees.length; ++i)
                    $root.proto.FixedCustomFee.encode(message.customFees[i], writer.uint32(/* id 12, wireType 2 =*/98).fork()).ldelim();
            return writer;
        };
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        ConsensusTopicInfo.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            ...
            while (reader.pos < end) {
                ...
                case 11: {
                        if (!(message.feeExemptKeyList && message.feeExemptKeyList.length))
                            message.feeExemptKeyList = [];
                        message.feeExemptKeyList.push($root.proto.Key.decode(reader, reader.uint32()));
                        break;
                    }
                case 12: {
                        if (!(message.customFees && message.customFees.length))
                            message.customFees = [];
                        message.customFees.push($root.proto.FixedCustomFee.decode(reader, reader.uint32()));
                        break;
                    }
                default:
                    reader.skipType(tag & 7);
        ...
        ConsensusTopicInfo.verify = function verify(message) {
            ...
            if (message.feeExemptKeyList != null && message.hasOwnProperty("feeExemptKeyList")) {
                if (!Array.isArray(message.feeExemptKeyList))
                    return "feeExemptKeyList: array expected";
                for (let i = 0; i < message.feeExemptKeyList.length; ++i) {
                    let error = $root.proto.Key.verify(message.feeExemptKeyList[i]);
                    if (error)
                        return "feeExemptKeyList." + error;
                }
            }
            if (message.customFees != null && message.hasOwnProperty("customFees")) {
                ...
                for (let i = 0; i < message.customFees.length; ++i) {
                    let error = $root.proto.FixedCustomFee.verify(message.customFees[i]);
                    if (error)
        ...
        ConsensusTopicInfo.fromObject = function fromObject(object) {
            ...
            if (object.runningHash != null)
                ...
                else if (object.runningHash.length >= 0)
            ...
            if (object.feeScheduleKey != null) {
                if (typeof object.feeScheduleKey !== "object")
                    throw TypeError(".proto.ConsensusTopicInfo.feeScheduleKey: object expected");
                message.feeScheduleKey = $root.proto.Key.fromObject(object.feeScheduleKey);
            }
            if (object.feeExemptKeyList) {
                if (!Array.isArray(object.feeExemptKeyList))
                    throw TypeError(".proto.ConsensusTopicInfo.feeExemptKeyList: array expected");
                message.feeExemptKeyList = [];
                for (let i = 0; i < object.feeExemptKeyList.length; ++i) {
                    if (typeof object.feeExemptKeyList[i] !== "object")
                        throw TypeError(".proto.ConsensusTopicInfo.feeExemptKeyList: object expected");
                    message.feeExemptKeyList[i] = $root.proto.Key.fromObject(object.feeExemptKeyList[i]);
                }
            }
            if (object.customFees) {
                if (!Array.isArray(object.customFees))
                    throw TypeError(".proto.ConsensusTopicInfo.customFees: array expected");
                message.customFees = [];
                for (let i = 0; i < object.customFees.length; ++i) {
                    if (typeof object.customFees[i] !== "object")
                        throw TypeError(".proto.ConsensusTopicInfo.customFees: object expected");
                    message.customFees[i] = $root.proto.FixedCustomFee.fromObject(object.customFees[i]);
                }
            }
            return message;
        };
        ...
        ConsensusTopicInfo.toObject = function toObject(message, options) {
            ...
            if (message.feeExemptKeyList && message.feeExemptKeyList.length) {
                object.feeExemptKeyList = [];
                for (let j = 0; j < message.feeExemptKeyList.length; ++j)
                    object.feeExemptKeyList[j] = $root.proto.Key.toObject(message.feeExemptKeyList[j], options);
            }
            if (message.customFees && message.customFees.length) {
                object.customFees = [];
                for (let j = 0; j < message.customFees.length; ++j)
                    object.customFees[j] = $root.proto.FixedCustomFee.toObject(message.customFees[j], options);
            }
            return object;
        };
